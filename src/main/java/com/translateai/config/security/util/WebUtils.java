package com.translateai.config.security.util;
...
public class WebUtils {
    ...
    public static String isInternalIP(String ipAddress) {
        try {
            ...
            if(addr.isSiteLocalAddress()){
                return Constants.INTERNAL_IP;
            }else{
                return Constants.EXTERNAL_IP;
            }
    ...
    public static String getUserAgentOs(HttpServletRequest request){
        ...
        if(!StringUtils.equals(operatingSystem.getName(), Constants.UNKNOWN)){
